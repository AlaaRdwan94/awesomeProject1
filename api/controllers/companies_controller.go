...
//this API will be used to create a Company object in the database
...
func (server *Server) UpdateCompanyPromotion(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
...
//this API will be used to get a Company by its ID from the database
...
//this API will be used to update a Company by its ID from the database
...
//this API will be used to delete a Company by its ID from the database
